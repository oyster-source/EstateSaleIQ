    ...
    return (
        <main className="min-h-screen p-4 md:p-8 max-w-7xl mx-auto space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                {/* Left: Image - Increased padding and height to prevent cutoff */}
                <div className="rounded-3xl overflow-hidden border-2 border-gold-800/30 shadow-glow relative group bg-black/40 flex items-center justify-center h-[500px] p-10">
                    <img src={item.image_url} alt="Uploaded Item" className="w-full h-full object-contain max-w-full max-h-full" />
